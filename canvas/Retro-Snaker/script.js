...
Snake.prototype.trigger=function(e){
	...
	if(eKey>=37 && eKey<=40 && eKey!=this.currKey && !( (this.currKey==37 && eKey==39)||(this.currKey==38 && eKey==40)||(this.currKey==39 && eKey==37)||(this.currKey==40 && eKey==38))&& this.pause==-1){//响应：上下左右&不是当前方向&不是反方向&不再暂停状态
			this.currKey=eKey;
